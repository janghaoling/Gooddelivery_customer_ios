...
class LoadingIndicator:NSObject{
    ...
    static var backgroundView:UIView = {
        let sView = UIView()
        sView.backgroundColor = UIColor.black.withAlphaComponent(0.6)
        return sView
    }()
    
    static var contentView:SpinnerView = {
        let sView = SpinnerView()
    ...
    static func frameSetup(){
        ...
        contentView.widthAnchor.constraint(equalTo: window.widthAnchor, multiplier: 0.1).isActive = true
        contentView.heightAnchor.constraint(greaterThanOrEqualTo: window.widthAnchor, multiplier: 0.1).isActive = true
