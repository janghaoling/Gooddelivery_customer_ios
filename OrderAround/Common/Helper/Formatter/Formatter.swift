...
class Formatter {
    ...
    func formatDateToString(dateString:String,fromFormat:String,toFormat:String) -> String?{
        initializeDateFormatter()
        self.dateFormatter?.dateFormat = fromFormat
        let currentFormat = self.dateFormatter?.date(from: dateString)
        self.dateFormatter?.dateFormat = toFormat
        let convertedDate = self.dateFormatter?.string(from: currentFormat!)
